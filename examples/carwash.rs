...
use rand::{Rng as RngT, SeedableRng, rngs::SmallRng as Rng, distributions::{Distribution, Uniform}};
use rand_distr::Exp;

use desim::{Effect, EndCondition, Simulation, ResourceId, SimState, SimGen};
use CarState::*;
...
fn car_process<'a>(carwash: ResourceId, rng: &'a mut Rng, distr_drive: &'a impl Distribution<f32>, distr_wash: &'a impl Distribution<f32>) -> Box<SimGen<CarState>> {
